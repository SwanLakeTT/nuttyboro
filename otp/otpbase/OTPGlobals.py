...
ToonSpeedFactor = 1.30
ToonForwardSpeed = 11.5 * ToonSpeedFactor
ToonJumpForce = 24.5
ToonReverseSpeed = 7.0 * ToonSpeedFactor
ToonRotateSpeed = 55.0 * ToonSpeedFactor
ToonForwardSlowSpeed = 6.0
ToonJumpSlowForce = 1.0
ToonReverseSlowSpeed = 2.5
ToonRotateSlowSpeed = 33.0
ToonDoubleTapSprintWindow = 0.60
ToonSprintFovIncrease = 5
ToonForwardSprintSpeed = 20 * ToonSpeedFactor
MickeySpeed = 1.0
MinnieSpeed = 3.2
DonaldSpeed = 3.68
GoofySpeed = 5.2
